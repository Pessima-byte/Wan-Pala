...
export const ROOM_THEMES: Record<string, RoomTheme> = {
  'lofi-cafe': {
    ...
    overlayGradient: 'from-black/80 via-black/50 to-black/80',
    ambientSound: 'rain'
  },
  'cyberpunk-loft': {
    id: 'cyberpunk-loft',
    ...
    overlayGradient: 'from-slate-950/85 via-purple-950/40 to-slate-950/85',
    ambientSound: 'city'
  },
  'retro-arcade': {
    id: 'retro-arcade',
    ...
    overlayGradient: 'from-slate-950/85 via-indigo-950/40 to-slate-950/85',
    ambientSound: 'arcade'
  },
  'sunset-drivein': {
    id: 'sunset-drivein',
    ...
    overlayGradient: 'from-slate-950/80 via-amber-950/30 to-slate-950/80',
    ambientSound: 'waves'
  },
  'anime-bedroom': {
    id: 'anime-bedroom',
    ...
    overlayGradient: 'from-slate-950/80 via-pink-950/20 to-slate-950/80',
    ambientSound: 'vinyl'
  },
  'minimal-dark': {
    id: 'minimal-dark',
